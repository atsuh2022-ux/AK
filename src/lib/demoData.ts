...
export const demoAlerts: Alert[] = [
  {
    ...
    created_at: '',
    profiles: { id: ATHLETE_ID, role: 'athlete', full_name: '久野 選手', created_at: '' },
  },
]
