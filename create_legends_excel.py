...
title_cell = ws6.cell(row=1, column=1,
    value="食事摂取基準 2025年版（18〜29歳）　推奨量／目安量／目標量　※空欄＝参照線なし・値を変更する場合はこのシートを編集してください")
...
# (キー, 単位, 種別, m18, f18, lbl_m, lbl_f)
# たんぱく質・食塩相当量は参照線なし（None）
dri_rows = [
    ("エネルギー",      "kcal/日", "推定必要量",   2650,  2000,
     "推定必要量(男)", "推定必要量(女)"),
    ("エネルギー_kg",   "kcal/kg", "参考値",        None,  None,  "", ""),
    ("たんぱく質",      "g/日",    "推奨量（参照線なし）", None, None, "", ""),
    ("たんぱく質/kg BW","g/kg",    "参考値",        None,  None,  "", ""),
    ("炭水化物",        "g/日",    "目標量(%E換算)",None,  None,  "", ""),
    ("炭水化物_kg",     "g/kg",    "目標量(%E換算)",None,  None,  "", ""),
    ("PFC",             "%E",      "目標量（帯表示）",None, None,  "", ""),
    ("食物繊維総量",    "g/日",    "目安量",          21,    18,
     "目安量(男)",     "目安量(女)"),
    ("食塩相当量",      "g/日",    "目標量（参照線なし）", None, None, "", ""),
    ("カルシウム",      "mg/日",   "推奨量",         800,   650,
     "推奨量(男)",     "推奨量(女)"),
    ("鉄",              "mg/日",   "推奨量",          7.5,  10.5,
     "推奨量(男)",     "推奨量(女)"),
    ("ビタミンD",       "µg/日",   "目安量",          12.0,  12.0,
     "目安量(男)",     "目安量(女)"),
    ("ビタミンB1",      "mg/日",   "推奨量",           1.4,   1.1,
     "推奨量(男)",     "推奨量(女)"),
    ("ビタミンB2",      "mg/日",   "推奨量",           1.6,   1.2,
     "推奨量(男)",     "推奨量(女)"),
    ("ビタミンB6",      "mg/日",   "推奨量",           1.4,   1.1,
     "推奨量(男)",     "推奨量(女)"),
...
add_note(ws6, 20, 1,
    "※ エネルギーはPAL II（ふつう）。ビタミンD 12.0µg は2025年版改定値（2020年版は8.5µg）。"
    "たんぱく質・食塩相当量は参照線を表示しない設定（値をNoneから変更すれば表示されます）。")
set_col_widths(ws6, [22, 10, 22, 14, 14, 18, 18])
